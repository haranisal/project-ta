    ...
    <aside class="left-sidebar">
      ...
      <div>
        <div class="brand-logo d-flex align-items-center justify-content-between">
          <a href="{{url('/home/admindas')}}" class="text-nowrap logo-img">
        ...
        <nav class="sidebar-nav scroll-sidebar" data-simplebar="">
          ...
          <li class="nav-small-cap">
            ...
            <li class="sidebar-item">
              <a class="sidebar-link" href="{{url('home/admindas')}}" aria-expanded="false">
                <span>
            ...
            <li class="sidebar-item">
              <a class="sidebar-link" href="{{url('datasiswa')}}" aria-expanded="false">
                <span>
            ...
            <li class="sidebar-item">
              <a class="sidebar-link" href="{{url('dataguru')}}" aria-expanded="false">
                <span>
                  <i class="ti ti-article"></i>
                </span>
            ...
            <li class="sidebar-item">
              <a class="sidebar-link" href="{{url('antrianta')}}" aria-expanded="false">
                <span>
                  <i class="ti ti-file-description"></i>
                </span>
                <span class="hide-menu">Antrian TA</span>
              </a>
            </li>
            <li class="sidebar-item">
              <a class="sidebar-link" href="{{url('pengajuanjudul')}}" aria-expanded="false">
                <span>
